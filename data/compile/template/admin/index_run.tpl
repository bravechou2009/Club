			...
			<table width="100%" height="100%" style="table-layout:fixed;">
				<tr class="head">
					...
					<div class="login_info">
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" target="_blank">home</a><span class="mr10">管理员： <?php echo htmlspecialchars($loginUser->username, ENT_QUOTES, 'UTF-8');?></span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?a=logout'; ?>" class="mr10">[注销]</a>
					</div></td>
				</tr>
				<tr class="tab">
					<th>
					<div class="search">
						...
						<button type="button" name="keyword" id="J_search" value="" data-url="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?c=find'; ?>">Go</button>
					</div></th>
					<td>
