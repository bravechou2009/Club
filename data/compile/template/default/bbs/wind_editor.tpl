...
<script>
	...
	*/
	...
	var IMAGE_CONFIG = {
		...
		uploadUrl: "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-upload-dorun?_json=1'; ?>",//上传地址
	...
	var ATTACH_CONFIG = {
		...
		uploadUrl : "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-upload-dorun?_json=1'; ?>",//上传地址
		modifyUrl : "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-upload-replace?_json=1'; ?>",//修改地址
		deleteUrl : '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-attach-delete?_json=1'; ?>',
    ...
    //表情数据的地址
    var EMOTION_URL = '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','emotion-index-run?type=bbs'; ?>';
    //at好友数据地址
    var AT_URL = '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-remind-run'; ?>';
    //at弹窗的地址
    //var AT_DIALOG_URL = '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-remind-friend'; ?>';
    var AT_USER_SPACE = '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-index-run'; ?>?uid=';
   //应用插件配置
	var editorApp = {
