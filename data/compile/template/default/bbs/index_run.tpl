...
<style type="text/css">
    			...
    			$__design_data = $__design->getDataByModules(array(6,4,3,));
					...
					<div class="box_wrap thread_page J_check_wrap">
						<nav>
							<div class="content_nav" id="hashpos_ttype">
								<div class="content_filter"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-index-run?order=postdate'; ?>" class="<?php echo htmlspecialchars(Pw::isCurrent($order == 'postdate'), ENT_QUOTES, 'UTF-8');?>">最新发帖</a><span>|</span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-index-run?order=lastpost'; ?>" class="<?php echo htmlspecialchars(Pw::isCurrent($order != 'postdate'), ENT_QUOTES, 'UTF-8');?>">最后回复</a></div>
								<ul>
									<li class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-index-run?order=lastpost'; ?>">本站新帖</a></li>
									<?php  if ($loginUser->isExists()) { ?><li><a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-forum-my'; ?>">我的版块</a></li><?php  } ?>
								</ul>
							</div>
						</nav>
						<!--公告-->
								...
								<tr>
									...
									<td class="subject">
										<p class="title">
											...
											<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($value['fid']),'.html'; ?>" class="st">[<?php echo $forums[$value['fid']]['name'];?>]</a>
											<?php  } ?>
...
PwHook::display(array($threadList, "runDo"), array('createHtmlAfterSubject',$value), "", $__viewer);
  ...
  if ($value['ifupload']) { ?><span class="posts_icon"><i class="icon_<?php echo htmlspecialchars($uploadIcon[$value['ifupload']], ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars($icon[$uploadIcon[$value['ifupload']]], ENT_QUOTES, 'UTF-8');?>"></i></span><?php  } ?>
						...
						<div class="management J_post_manage_col" data-role="list">
							...
							<?php  if ($operateThread['topped']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-topped'; ?>">置顶</a><?php  } 
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-index-run?page=', rawurlencode($_page_i); 
...
<?php } ?>
  ...
  if ($operateThread['move']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-move'; ?>">移动</a></li><?php  } 
...
<?php  }} ?>
<div role="structure_hwfnze" data-lcm="100" class="box_wrap design_layout_style J_mod_layout" id="hwfnze">			<h2 role="titlebar" class="design_layout_hd cc J_layout_hd" style=""><span>社区热帖</span></h2>			<div class="design_layout_ct J_layout_item"><div id="J_mod_6" style="" data-id="6" data-model="thread" class="mod_box J_mod_box"><div class="tmode_list tmode_list_sort">
<ul>
<?php if(is_array($__design_data['J_mod_6'])){
	...
	<li><span class="time"><?php echo WindSecurity::escapeHTML($__v['threadTime']);?></span><a href="<?php echo WindSecurity::escapeHTML($__v['url']);?>" target="_blank" target="_blank"><?php if($__v['__style']){?><span style="<?php echo WindSecurity::escapeHTML($__v['__style']);?>"><?php echo WindSecurity::escapeHTML($__v['title']);?></span><?php }else{
 echo WindSecurity::escapeHTML($__v['title']);
 }?></a></li>
<?php }?>
</ul>
</div></div></div></div><div role="structure_ucgdqd" data-lcm="100" class="design_layout_style J_mod_layout box_wrap" id="ucgdqd">			<h2 role="titlebar" class="design_layout_hd cc J_layout_hd" style=""><span><a href="index.php?m=tag" style="color: #205867;">热门</a></span></h2>			<div class="design_layout_ct J_layout_item"><div id="J_mod_4" style="" data-id="4" data-model="tag" class="mod_box J_mod_box"><div class="tmode_list tmode_list_sort">
<ul>
<?php if(is_array($__design_data['J_mod_4'])){
						$__data=$__design_data['J_mod_4'];
					}else{
						$display=Wekit::load('design.srv.display.PwDesignDisplay');
						$__data=$display->getModuleData(4);
					};foreach($__data AS $__k=>$__v){?>
	<li><span class="time"><?php echo WindSecurity::escapeHTML($__v['attention_count']);?></span><a href="<?php echo WindSecurity::escapeHTML($__v['url']);?>" target="_blank" target="_blank"><?php if($__v['__style']){?><span style="<?php echo WindSecurity::escapeHTML($__v['__style']);?>"><?php echo WindSecurity::escapeHTML($__v['title']);?></span><?php }else{
 echo WindSecurity::escapeHTML($__v['title']);
 }?></a></li>
<?php }?>
</ul>
...
<div class="footer_wrap">
	<div class="footer">
		<div role="structure_uzdilf" data-lcm="100" class="design_layout_style J_mod_layout box_wrap" id="uzdilf">			<h2 role="titlebar" class="design_layout_hd cc J_layout_hd" style=""><span>友情链接</span></h2>			<div class="design_layout_ct J_layout_item"><div id="J_mod_3" style="" data-id="3" data-model="link" class="mod_box J_mod_box"><div class="tmode_traverseList">
<ul class="cc">
