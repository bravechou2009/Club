...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb">
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-like-run'; ?>">喜欢</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-like-run'; ?>">热门喜欢</a>
		</div>
		<div class="like_page_run cc">
			<div class="like_nav cc">
				<ul>
					<li  class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-like-run'; ?>">热门喜欢</a></li>
					<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-mylike-ta'; ?>" data-referer="true" class="J_qlogin_trigger" rel="nofollow">Ta的喜欢</a></li>
					<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-mylike-run'; ?>" data-referer="true" class="J_qlogin_trigger" rel="nofollow">我的喜欢</a></li>
				</ul>
			</div>
...
<script>
var J_LIKE_URL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-like-data?moduleid=', rawurlencode($datamodule),'&pageid=', rawurlencode($pageid),'&page=', rawurlencode($page); ?>",getdata="<?php echo htmlspecialchars($getdata, ENT_QUOTES, 'UTF-8');?>";
var LIKE_PLUS = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','like-mylike-doLike?typeid=_FROMTYPE&fromid=_KEY'; ?>";		//点击喜欢地址
