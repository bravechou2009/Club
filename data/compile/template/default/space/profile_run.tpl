		...
		<div class="space_content">
			<div class="box">
				...
				<div class="space_profile">
					<h3>
						<?php  if ($space->tome == 2){ ?>
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','profile-index-run?_tab=profile'; ?>" class="edit">编辑</a>
						<?php  } ?>
						<strong>基本资料</strong>
					</h3>
					<dl class="cc">
  ...
  if ($space->allowView('nation')){ ?>
			...
			<?php  if ($space->allowView('aliwangwang') || $space->allowView('qq') || $space->allowView('msn') || $space->allowView('mobile')){ ?>
				<div class="space_profile">
					<h3>
					<?php  if ($space->tome == 2){?>
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','profile-index-contact?_tab=contact'; ?>" class="edit">编辑</a>
					<?php  } ?>
						<strong>联系方式</strong>
					</h3>
