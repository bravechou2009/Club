...
?>
		...
		<div class="space_content" id="J_feed_lists">
			...
			<div class="box">
				<div class="space_fresh">
					<dl class="cc">
						<dt><a class="J_user_card_show" data-uid="<?php echo htmlspecialchars($value['created_userid'], ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','user/', rawurlencode($value['created_userid']),'.html'; ?>" target="_blank"><img class="J_avatar" src="<?php echo htmlspecialchars(Pw::getAvatar($value['created_userid'], 'small'), ENT_QUOTES, 'UTF-8');?>" data-type="small" width="50" height="50" /></a></dt>
						<dd>
							<?php  if ($value['title']) { ?>
							<div class="title"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','user/', rawurlencode($value['created_userid']),'.html'; ?>" class="author J_user_card_show" data-uid="<?php echo htmlspecialchars($value['created_userid'], ENT_QUOTES, 'UTF-8');?>" target="_blank"><?php echo htmlspecialchars($value['created_username'], ENT_QUOTES, 'UTF-8');?></a>：
							<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','articles/', rawurlencode($value['src_id']),'.html'; ?>" class="subject" target="_blank"><?php echo htmlspecialchars($value['title'], ENT_QUOTES, 'UTF-8');?></a>
							</div>
  ...
  if ($value['is_read_all']) { ?>
							<a target="_blank" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','articles/', rawurlencode($value['src_id']),'.html'; ?>" class="more">全文</a>
							<?php  } ?>
							</div>
							<?php  } else { ?>
							<div class="title"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','user/', rawurlencode($value['created_userid']),'.html'; ?>" class="author J_user_card_show" data-uid="<?php echo htmlspecialchars($value['created_userid'], ENT_QUOTES, 'UTF-8');?>" target="_blank"><?php echo htmlspecialchars($value['created_username'], ENT_QUOTES, 'UTF-8');?></a>：
 ...
 if ($_picCount > 4) {?><li>共<?php echo htmlspecialchars($_picCount, ENT_QUOTES, 'UTF-8');?>张图片</li><?php }?>
  ...
  if ($value['quote']) { ?>
								<div class="feed_repeat feed_quote">
									...
									<div class="title"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','user/', rawurlencode($value['quote']['created_userid']),'.html'; ?>" class="name" target="_blank"><?php echo htmlspecialchars($value['quote']['created_username'], ENT_QUOTES, 'UTF-8');?></a>：
									<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','articles/', rawurlencode($value['quote']['tid']),'.html'; ?>" class="subject" target="_blank"><?php echo htmlspecialchars($value['quote']['subject'], ENT_QUOTES, 'UTF-8');?></a>
									</div>
					...
					<p class="my_info">
						<?php  if($loginUser->uid) { ?>
						<span class="right"><a rel="nofollow" data-id="<?php echo htmlspecialchars($value['id'], ENT_QUOTES, 'UTF-8');?>" class="J_feed_toggle" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-index-reply?id=', rawurlencode($value['id']),'&uid=', rawurlencode($space->spaceUid); ?>">回复<span style="<?php echo htmlspecialchars($style_reply, ENT_QUOTES, 'UTF-8');?>">(<em id="J_feed_count_<?php echo htmlspecialchars($value['id'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($value['replies'], ENT_QUOTES, 'UTF-8');?></em>)</span></a></span>
						<?php  } ?>
						<span class="time"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-index-fresh?uid=', rawurlencode($value['created_userid']),'&id=', rawurlencode($value['id']); ?>"><?php echo htmlspecialchars(Pw::time2str($value['created_time'], 'auto'), ENT_QUOTES, 'UTF-8');?></a></span>&nbsp;来自<?php echo $value['from'];?>
					</p>
				</div>
			</div>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','user/', rawurlencode($space->spaceUid),'.html?page=', rawurlencode($_page_i); 
...
?>
			<div class="box">
				<div class="hd">
					<?php  if ($space->tome == 2){ ?>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','my-visitor-run'; ?>" class="more">全部</a>
					<?php  } ?>
...
?>
			<div class="box">
				<div class="hd">
				<?php  if ($space->tome == 2){ ?>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','profile-tag-run?_tab=tag'; ?>" class="more">管理</a>
				<?php  } ?>
				...
				<div class="ct">
					...
					<?php  foreach($tags AS $key => $value){ ?>
						<a rel="nofollow" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','my-friend-search?usertag=', rawurlencode($value['name']); ?>"><?php echo htmlspecialchars($value['name'], ENT_QUOTES, 'UTF-8');?></a>
					<?php  } ?>	
					</div>
				</div>
			</div>
...
?>
			<div class="box">
				<div class="hd">
				<?php  if ($space->tome == 2){ ?>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','tag-index-my'; ?>" class="more">全部</a>
				<?php  } ?>
				...
				<div class="ct">
					<div class="space_topic_list">
						...
						<?php  foreach($tags AS $value){ ?>
							<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','tag/', rawurlencode($value['tag_name']),'.html'; ?>"><?php echo htmlspecialchars($value['tag_name'], ENT_QUOTES, 'UTF-8');?></a><span>(<?php echo htmlspecialchars($value['content_count'], ENT_QUOTES, 'UTF-8');?>)</span></li>
						<?php  } ?>	
						</ul>
					</div>
				</div>
...
?>
			<div class="box">
				<div class="hd">
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-follows-run?uid=', rawurlencode($space->spaceUid); ?>" class="more">全部</a>
...
?>
			<div class="box">
				<div class="hd">
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-fans-run?uid=', rawurlencode($space->spaceUid); ?>" class="more">全部</a>
...
<script>
//新鲜事回复提交地址
var FRESH_DOREPLY = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-myspace-doreply'; ?>";
