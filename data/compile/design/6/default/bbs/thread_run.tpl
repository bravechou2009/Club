...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb" id="bread_crumb">
			<?php echo $headguide;
  if ($tab == 'digest') { ?><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html?tab=digest'; ?>">精华</a><?php  } 
  if ($type) { ?><em>&gt;</em>
				<?php  $_urladd_ = $tab ? '&tab=' . $tab : ''; 
  if ($_parentid = $topictypes['all_types'][$type]['parentid']) { ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html?type=', rawurlencode($_parentid); 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');?>"><?php echo $topictypes['all_types'][$_parentid]['name'];?></a><em>&gt;</em>
				<?php  } ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html?type=', rawurlencode($type); 
	...
	<div class="forum_info_box cc" id="J_forum_info_box">
		...
		<div class="name">
			<?php  if ($loginUser->isExists() && $pwforum->foruminfo['type'] != 'category') { ?>
				...
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-forum-join?fid=', rawurlencode($fid); ?>" data-role="join" data-fid="<?php echo htmlspecialchars($fid, ENT_QUOTES, 'UTF-8');?>" class="core_follow J_forum_join J_qlogin_trigger">加入版块</a>
				<?php  } else { ?>
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-forum-quit?fid=', rawurlencode($fid); ?>" data-role="quit" data-fid="<?php echo htmlspecialchars($fid, ENT_QUOTES, 'UTF-8');?>" class="core_unfollow J_forum_join">已加入<span>&nbsp;&nbsp;|&nbsp;&nbsp;取消</span></a>
				<?php  } ?>
				</span>
			<?php  } ?>
 ...
 echo htmlspecialchars($key ? '，' : '', ENT_QUOTES, 'UTF-8');?><a class="J_user_card_show" data-username="<?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','space-index-run?username=', rawurlencode($value); ?>"><?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?></a><?php  } ?>
		</div>
		<?php  } ?>
		<div class="notice">
 ...
 PwHook::segment("forum_list_table", array($pwforum->foruminfo,$sub), "one_across", "", $__viewer); 
	...
	<?php  } ?>
					...
					<div class="pages_wrap cc">
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-post-run?fid=', rawurlencode($pwforum->fid); ?>" class="btn_post J_thread_post_btn<?php echo htmlspecialchars($postNeedLogin, ENT_QUOTES, 'UTF-8');?>" data-rel="J_thread_post_types_1">发帖</a>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'-', rawurlencode($_page_i),'.html'; 
...
<?php } ?>
					...
					<div class="box_wrap thread_page J_check_wrap">
						<nav>
							<div class="content_nav">
								...
								?>
								<div class="content_filter"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html'; 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');
 echo htmlspecialchars($defaultOrderby == 'lastpost' ? '&orderby=postdate' : '', ENT_QUOTES, 'UTF-8');?>" class="<?php echo htmlspecialchars(Pw::isCurrent($orderby == 'postdate'), ENT_QUOTES, 'UTF-8');?>">最新发帖</a><span>|</span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html'; 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');
 echo htmlspecialchars($defaultOrderby == 'lastpost' ? '' : '&orderby=lastpost', ENT_QUOTES, 'UTF-8');?>" class="<?php echo htmlspecialchars(Pw::isCurrent($orderby != 'postdate'), ENT_QUOTES, 'UTF-8');?>">最后回复</a></div>
								<ul class="cc" id="hashpos_ttype">
									<li class="<?php echo htmlspecialchars(Pw::isCurrent(!$tab), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html'; ?>">全部</a></li>
									<li class="<?php echo htmlspecialchars(Pw::isCurrent('digest' == $tab), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($fid),'.html?tab=digest'; ?>">精华</a></li>
									<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-user-run?fid=', rawurlencode($fid); ?>">会员</a></li>
								</ul>
							</div>
							...
							<div class="content_type">
								<ul class="cc">
									<li class="<?php echo htmlspecialchars(Pw::isCurrent(!$type), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($pwforum->fid),'.html'; 
										...
										<div class="fl J_menu_drop_list"  style="margin-top:22px;display:none;">
											<div class="core_menu">
												<ul class="core_menu_list cc">
													...
													<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($pwforum->fid),'.html?type=', rawurlencode($v2['id']); 
 echo htmlspecialchars($_urladd_, ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars(strip_tags($v2['name']), ENT_QUOTES, 'UTF-8');?>"><?php echo $v2['name'];?></a></li>
										...
										<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($pwforum->fid),'.html?type=', rawurlencode($v['id']); 
...
<?php  } ?>
<tr>
	<td class="author"><a class="J_user_card_show" data-uid="<?php echo htmlspecialchars($value['created_userid'], ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','user/', rawurlencode($value['created_userid']),'.html'; ?>"><img class="J_avatar" src="<?php echo htmlspecialchars(Pw::getAvatar($value['created_userid'], 'small'), ENT_QUOTES, 'UTF-8');?>" data-type="small" width="45" height="45" alt="<?php echo htmlspecialchars($value['created_username'], ENT_QUOTES, 'UTF-8');?>" /></a></td>
	<td class="subject">
		<p class="title">
			...
			<?php  } ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','articles/', rawurlencode($value['tid']),'.html'; ?>" target="_blank"><span class="posts_icon"><i class="icon_<?php echo htmlspecialchars($value['icon'], ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars($icon[$value['icon']], ENT_QUOTES, 'UTF-8');?>  新窗口打开"></i></span></a>
  ...
  if ($_parentid = $topictypes['all_types'][$value['topic_type']]['parentid']) { ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($pwforum->fid),'.html?type=', rawurlencode($_parentid); ?>" class="st">[<?php echo $topictypes['all_types'][$_parentid]['name'];?>]</a>
				<?php  } ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($pwforum->fid),'.html?type=', rawurlencode($value['topic_type']); ?>" class="st">[<?php echo $topictypes['all_types'][$value['topic_type']]['name'];?>]</a>
			<?php  } ?>
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','articles/', rawurlencode($value['tid']),'.html'; ?>" class="st" style="<?php echo htmlspecialchars($value['highlight_style'], ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars($value['subject'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars(Pw::substrs($value['subject'],$numofthreadtitle), ENT_QUOTES, 'UTF-8');?></a>
			<?php
...
<?php  $tpc_topped = isset($value['issort']); 
  ...
  if ($operateThread['topped']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-topped'; ?>">置顶</a><?php  } 
  if ($operateThread['digest']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-digest'; ?>">精华</a><?php  } 
  if ($operateThread['highlight']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-highlight'; ?>">加亮</a><?php  } 
  if ($operateThread['up']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-up'; ?>">提前</a><?php  } 
  if ($hasFirstPart && $hasSecondPart){ ?><i>|</i><?php  } 
  if ($operateThread['type']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-type'; ?>">分类</a><?php  } 
  if ($operateThread['move']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-move'; ?>">移动</a><?php  } 
  if ($operateThread['copy']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-copy'; ?>">复制</a><?php  } 
  if ($operateThread['unite']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-unite'; ?>">合并</a><?php  } 
  if ($hasThirdPart && ($hasFirstPart ^ $hasSecondPart || $hasFirstPart && $hasSecondPart)){ ?><i>|</i><?php  } 
  if ($operateThread['lock']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-lock'; ?>">锁定</a><?php  } 
  if ($operateThread['down']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-down'; ?>">压帖</a><?php  } 
  if (($hasFirstPart || $hasSecondPart || $hasThirdPart) && $hasFirthPart){ ?><i>|</i><?php  } 
  if ($operateThread['delete']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-delete'; ?>">删除</a><?php  } 
  if ($operateThread['ban']){ ?><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-ban'; ?>">禁止</a><?php  } ?>
							</div>
							<?php  } 
  } else { ?>
					...
					<div class="pages_wrap cc">
						<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-post-run?fid=', rawurlencode($pwforum->fid); ?>" class="btn_post J_thread_post_btn<?php echo htmlspecialchars($postNeedLogin, ENT_QUOTES, 'UTF-8');?>" data-rel="J_thread_post_types_2">发帖</a>
						<div class="J_page_wrap" data-key="true">
<?php $__tplPageCount=(int)$count;
$__tplPagePer=(int)$perpage;
$__tplPageTotal=(int)$totalpage;
...
<div class="box_wrap my_forum_list"><!--切换样式 my_forum_list_cur -->
	...
	<?php  foreach ($myJoinForum as $v => $k) { ?>
		<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($v),'.html'; ?>"><?php echo htmlspecialchars($k, ENT_QUOTES, 'UTF-8');?></a></li>
	<?php  } ?>
	</ul>
</div>
<?php  } ?>
<!--advertisement id='Site.Sider.User' sys='1'/-->
  ...
  if ($forumdb[$cate['fid']]) { ?>
				<dl class="<?php echo htmlspecialchars(Pw::isCurrent($k == $__currentCateId), ENT_QUOTES, 'UTF-8');?>">
					<dt class="J_sidebar_forum_toggle"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($cate['fid']),'.html'; ?>"><?php echo htmlspecialchars(strip_tags($cate['name']), ENT_QUOTES, 'UTF-8');?></a></dt>
					<dd role="tabpanel">
						<?php  foreach ($forumdb[$cate['fid']] as $forums) { ?>
						<p><a class="<?php echo htmlspecialchars(Pw::isCurrent($forums['fid'] == $__currentFid), ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','thread/', rawurlencode($forums['fid']),'.html'; ?>"><?php echo htmlspecialchars(strip_tags($forums['name']), ENT_QUOTES, 'UTF-8');?></a></p>
						<?php  } ?>
					</dd>
				</dl>
				<?php  } 
...
<div class="box_wrap">
	...
	<ul class="cc">
		...
		<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','tag/', rawurlencode($v['tag_name']),'.html'; ?>" class="title"><?php echo htmlspecialchars($v['tag_name'], ENT_QUOTES, 'UTF-8');?></a></li>
		<?php  } ?>
	</ul>
	</div>
</div>
				...
				<div class="pop_cont">
					<div class="pop_operat_list">
						<ul class="cc J_post_manage_col" data-role="list">
							<?php  if ($operateThread['topped']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-topped'; ?>">置顶</a></li><?php  } 
  if ($operateThread['digest']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-digest'; ?>">精华</a></li><?php  } 
  if ($operateThread['highlight']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-highlight'; ?>">加亮</a></li><?php  } 
  if ($operateThread['up']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-up'; ?>">提前</a></li><?php  } 
  if ($operateThread['type']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-type'; ?>">分类</a></li><?php  } ?>
							<!-- <li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-topped'; ?>">印戳</a></li>  -->
							<?php  if ($operateThread['move']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-move'; ?>">移动</a></li><?php  } 
  if ($operateThread['copy']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-copy'; ?>">复制</a></li><?php  } 
  if ($operateThread['unite']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-unite'; ?>">合并</a></li><?php  } 
  if ($operateThread['lock']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-lock'; ?>">锁定</a></li><?php  } 
  if ($operateThread['down']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-down'; ?>">压帖</a></li><?php  } 
  if ($operateThread['delete']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-delete'; ?>">删除</a></li><?php  } 
  if ($operateThread['ban']){ ?><li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-manage-ban'; ?>">禁止</a></li><?php  } ?>
						</ul>
					</div>
				</div>
			</div>
...
<?php  } 
  if ($loginUser->isExists()) { ?>
	var JOIN_URL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-forum-join'; ?>",		//版块加入
			QUIT_URL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','bbs-forum-quit'; ?>",		//版块退出
			lock = false;
